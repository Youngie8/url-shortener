  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 border p-2 rounded-lg">
        ...
        <Link to={`/link/${url?.id}`} className="flex flex-col flex-1">
            ...
            <span className=" text-2xl text-blue-400 font-bold hover:underline cursor-pointer">https://scissor.com/{url?.custom_url? url?.custom_url : url.short_url}</span>
        ...
        <div className="flex gap-2">
            <Button variant="ghost" onclick={() => navigator.clipboard.writeText(`https://scissor.com/${url?.short_url}`)}>
                <Copy/>
            </Button>
